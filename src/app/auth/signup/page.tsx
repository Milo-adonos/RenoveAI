...
function isTikTokBrowser() {
  ...
  return /BytedanceWebview|ByteLocale|musical_ly|TikTok/i.test(
    navigator.userAgent
  );
}
    ...
    <main className="min-h-screen bg-background">
      {isTikTok && (
        <div
          ...
          style={{ backgroundColor: "#A0522D", padding: 16 }}
        >
          <p
            className="mb-3"
            style={{
          ...
          >
            Pour te connecter avec Google, ouvre cette page dans ton navigateur 👇
          </p>
          <button
            type="button"
            onClick={() =>
              window.open("https://renoveai.com/auth/signup", "_blank")
            }
            className="font-semibold rounded-full px-5 py-2.5"
            style={{
              fontFamily: "var(--font-inter), Inter, sans-serif",
              fontSize: "14px",
      ...
      <div className="px-5 py-8 max-w-[390px] mx-auto w-full">
        ...
        {isTikTok && (
          ...
          >
            Tu préfères Google ? Ouvre cette page dans Safari ou Chrome.
          </p>
        )}
